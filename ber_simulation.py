...
# Generated: Sun Nov 24 12:41:47 2019
##################################################
...
class ber_simulation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._offset_range = Range(0, math.pi/2, math.pi/20, math.pi/4, 20)
        self._offset_win = RangeWidget(self._offset_range, self.set_offset, 'Offset', "dial", float)
